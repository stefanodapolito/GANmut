...
python -u main.py --mode train --image_size 128 --architecture_v2 1.\
               ...
               --sample_dir samples/samples_linear_2d_v2 --log_dir GANmut/logs_linear_2d_v2 \
               --model_save_dir GANmut/models_linear_2d_v2 --result_dir GANmut/results_linear_2d_v2 "$@"
